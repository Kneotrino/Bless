 ...
 * @author SEED
 */
public class PanelLaporanSaham extends JPanel {
    
    public PanelLaporanSaham() {
        initComponents();
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT l FROM LaporanSaham l");
        ...
        org.jdesktop.beansbinding.ELProperty eLProperty = org.jdesktop.beansbinding.ELProperty.create("${selectedElement.relasis}");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == newButton) {
                PanelLaporanSaham.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                PanelLaporanSaham.this.deleteButtonActionPerformed(evt);
            }
            else if (evt.getSource() == saveButton) {
                PanelLaporanSaham.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                PanelLaporanSaham.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteDetailButton) {
                PanelLaporanSaham.this.deleteDetailButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newDetailButton) {
                PanelLaporanSaham.this.newDetailButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteDetailButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteDetailButtonActionPerformed
        ...
        app.table.LaporanSaham l = list.get(masterTable.convertRowIndexToModel(index));
        Collection<app.table.Relasi> rs = l.getRelasis();
        int[] selected = detailTable.getSelectedRows();
        List<app.table.Relasi> toRemove = new ArrayList<app.table.Relasi>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            selected[idx] = detailTable.convertRowIndexToModel(selected[idx]);
            int count = 0;
            Iterator<app.table.Relasi> iter = rs.iterator();
            while (count++ < selected[idx]) {
                iter.next();
            }
            app.table.Relasi r = iter.next();
            toRemove.add(r);
    ...
    private void newDetailButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newDetailButtonActionPerformed
        ...
        Collection<app.table.Relasi> rs = l.getRelasis();
        if (rs == null) {
            rs = new LinkedList<app.table.Relasi>();
            l.setRelasis((List) rs);
        }
        app.table.Relasi r = new app.table.Relasi();
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<app.table.LaporanSaham> toRemove = new ArrayList<app.table.LaporanSaham>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            app.table.LaporanSaham l = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(l);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        app.table.LaporanSaham l = new app.table.LaporanSaham();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<app.table.LaporanSaham> merged = new ArrayList<app.table.LaporanSaham>(list.size());
            for (app.table.LaporanSaham l : list) {
    ...
    private java.util.List<app.table.LaporanSaham> list;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PanelLaporanSaham.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new PanelLaporanSaham());
